...
export declare class Browser {
  ...
  --enable-automation is on the commandline. */
    ...
    getHistograms(params: Browser.GetHistogramsParameters): Promise<Browser.GetHistogramsReturn>;
    /** Get a Chrome histogram by name. */
    getHistogram(params: Browser.GetHistogramParameters): Promise<Browser.GetHistogramReturn>;
...
export declare namespace Browser {
    ...
    type GetBrowserCommandLineReturn = {
...
export declare namespace CSS {
  ...
  inspector" rules), "regular" for regular stylesheets. */
    ...
    type FontsUpdatedParameters = {
        /** The web font that has loaded. */
        font?: FontFace;
    };
    type FontsUpdatedHandler = (params: FontsUpdatedParameters) => void;
...
export declare class DOM {
  ...
  $x functions). */
    ...
    getFrameOwner(params: DOM.GetFrameOwnerParameters): Promise<DOM.GetFrameOwnerReturn>;
...
export declare class Inspector {
    ...
    private _targetReloadedAfterCrash;
    private _client;
    constructor(client: IDebuggingProtocolClient);
    ...
    targetReloadedAfterCrash: Inspector.TargetReloadedAfterCrashHandler | null;
}
export declare namespace Inspector {
    ...
    type TargetReloadedAfterCrashHandler = () => void;
}
...
export declare class Memory {
    ...
    startSampling(params: Memory.StartSamplingParameters): Promise<void>;
...
export declare namespace Memory {
    ...
    type GetAllTimeSamplingProfileReturn = {
        profile: SamplingProfile;
    };
    type GetBrowserSamplingProfileReturn = {
        profile: SamplingProfile;
    };
...
export declare class Network {
    ...
    private _signedExchangeReceived;
  ...
  detailed cookie information in the `cookies` field. */
    ...
    getRequestPostData(params: Network.GetRequestPostDataParameters): Promise<Network.GetRequestPostDataReturn>;
  ...
  is specified. */
    takeResponseBodyForInterceptionAsStream(params: Network.TakeResponseBodyForInterceptionAsStreamParameters): Promise<Network.TakeResponseBodyForInterceptionAsStreamReturn>;
  ...
  mocked. */
    ...
    signedExchangeReceived: Network.SignedExchangeReceivedHandler | null;
...
export declare namespace Network {
  ...
  https://tools.ietf.org/html/draft-west-first-party-cookies */
    ...
    type BlockedReason = "other" | "csp" | "mixed-content" | "origin" | "inspector" | "subresource-filter" | "content-type";
    /** HTTP response data. */
    interface Response {
  ...
  sent. Response will intercept after the response is received. */
    ...
    type SignedExchangeReceivedParameters = {
        /** Request identifier. */
        requestId: RequestId;
        /** Information about the signed exchange response. */
        info: SignedExchangeInfo;
    };
    type SignedExchangeReceivedHandler = (params: SignedExchangeReceivedParameters) => void;
    ...
    type TakeResponseBodyForInterceptionAsStreamReturn = {
...
export declare class Page {
    ...
    private _navigatedWithinDocument;
  ...
  information in the `cookies` field. */
    ...
    setBypassCSP(params: Page.SetBypassCSPParameters): Promise<void>;
    /** Overrides the values of device screen dimensions (window.screen.width, window.screen.height,
  window.innerWidth, window.innerHeight, and "device-width"/"device-height"-related CSS media
  query results). */
  ...
  https://github.com/WICG/web-lifecycle/ */
    setWebLifecycleState(params: Page.SetWebLifecycleStateParameters): Promise<void>;
  ...
  open. */
    ...
    navigatedWithinDocument: Page.NavigatedWithinDocumentHandler | null;
...
export declare namespace Page {
    ...
    type ResourceType = "Document" | "Stylesheet" | "Image" | "Media" | "Font" | "Script" | "TextTrack" | "XHR" | "Fetch" | "EventSource" | "WebSocket" | "Manifest" | "SignedExchange" | "Other";
    ...
    type NavigatedWithinDocumentParameters = {
        /** Id of the frame. */
        frameId: FrameId;
        /** Frame's new url. */
        url: string;
    };
    type NavigatedWithinDocumentHandler = (params: NavigatedWithinDocumentParameters) => void;
...
export declare class Security {
    ...
    setIgnoreCertificateErrors(params: Security.SetIgnoreCertificateErrorsParameters): Promise<void>;
...
export declare class Target {
  ...
  beforeunload hooks. */
    disposeBrowserContext(params: Target.DisposeBrowserContextParameters): Promise<void>;
